metadata = {
  ...
  "keywords": [
    ...
    },
    {
      ...
      "slug": "allied",
      "name": "Allied",
      "refText": "Your hero becomes the Allied class after you select this treasure.",
      "text": "Your hero becomes the Allied class after you select this treasure.",
      "gameModes": [4]
    },
    {
      "id": 238,
  ...
  "numericFields": ["manaCost", "attack", "health", "armor"],
  "cardBackCategories": [
    {
      "slug": "base",
      "id": 1,
